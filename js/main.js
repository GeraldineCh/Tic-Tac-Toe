...
function nuevaPartida() {
    ...
    "use strict";
    uno.setAttribute("value", "e");
    dos.setAttribute("value", "e");
    tres.setAttribute("value", "e");
    cuatro.setAttribute("value", "e");
    cinco.setAttribute("value", "e");
    seis.setAttribute("value", "e");
    siete.setAttribute("value", "e");
    ocho.setAttribute("value", "e");
    nueve.setAttribute("value", "e");
}

for (contador = 0; contador < tablero.length; contador += 1) {
    tablero[contador].addEventListener("click", inicio);
}

reinicio.addEventListener("click", nuevaPartida);
